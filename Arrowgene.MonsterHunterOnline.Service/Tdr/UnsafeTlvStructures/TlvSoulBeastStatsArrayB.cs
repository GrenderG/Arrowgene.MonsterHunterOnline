...
{
    /// <summary>
    /// TLV Structure for soul beast stats arrays (variant B).
    /// C++ Reader: crygame.dll+sub_1020A600 (UnkTlv0221)
    /// C++ Printer: crygame.dll+sub_1020B010
    /// </summary>
    public class TlvSoulBeastStatsArrayB : Structure, ITlvStructure
    {
        // --- Hardcoded Boundary ---
