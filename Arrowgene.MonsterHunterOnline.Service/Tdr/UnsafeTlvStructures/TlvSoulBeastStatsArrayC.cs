...
{
    /// <summary>
    /// TLV Structure for soul beast stats arrays (variant C).
    /// C++ Reader: crygame.dll+sub_1020C6E0 (UnkTlv0222)
    /// C++ Printer: crygame.dll+sub_1020D020
    /// </summary>
    public class TlvSoulBeastStatsArrayC : Structure, ITlvStructure
    {
        // --- Hardcoded Boundary ---
