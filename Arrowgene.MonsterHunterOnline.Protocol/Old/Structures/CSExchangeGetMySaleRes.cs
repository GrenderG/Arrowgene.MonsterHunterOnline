...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 查询我的拍卖回复
    /// </summary>
    public class CSExchangeGetMySaleRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSExchangeGetMySaleRes));

        public CSExchangeGetMySaleRes()
        {
            Ret = 0;
