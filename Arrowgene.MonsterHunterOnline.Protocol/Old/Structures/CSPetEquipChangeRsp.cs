...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物换装应答
    /// </summary>
    public class CSPetEquipChangeRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetEquipChangeRsp));

        public CSPetEquipChangeRsp()
        {
            ErrCode = 0;
            Idx = 0;
            UID = 0;
