...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 通知移动物品
    /// </summary>
    public class S2CGuildMoveItemNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(S2CGuildMoveItemNtf));

        public S2CGuildMoveItemNtf()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
