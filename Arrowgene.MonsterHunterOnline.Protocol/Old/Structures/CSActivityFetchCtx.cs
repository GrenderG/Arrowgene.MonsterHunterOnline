...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 领取奖励上下文
    /// </summary>
    public class CSActivityFetchCtx : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSActivityFetchCtx));

        public CSActivityFetchCtx()
        {
            Arg1 = 0;
            Arg2 = 0;
            Arg3 = 0;
