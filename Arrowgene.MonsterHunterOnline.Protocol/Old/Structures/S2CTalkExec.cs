...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 对话执行
    /// </summary>
    public class S2CTalkExec : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(S2CTalkExec));
