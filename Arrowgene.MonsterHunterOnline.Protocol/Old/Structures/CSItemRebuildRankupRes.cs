...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求rankup
    /// </summary>
    public class CSItemRebuildRankupRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemRebuildRankupRes));

        public CSItemRebuildRankupRes()
        {
            ErrCode = 0;
            ItemID = 0;
            ItemColumn = 0;
