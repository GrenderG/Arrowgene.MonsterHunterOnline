...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 领取可选礼包开包
    /// </summary>
    public class CSFetchSelectItemBoxOpenBoxNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSFetchSelectItemBoxOpenBoxNtf));

        public CSFetchSelectItemBoxOpenBoxNtf()
        {
            Box = 0;
