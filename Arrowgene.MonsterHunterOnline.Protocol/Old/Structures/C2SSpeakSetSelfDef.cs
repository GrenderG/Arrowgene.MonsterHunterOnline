...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 设置自定义发言
    /// </summary>
    public class C2SSpeakSetSelfDef : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(C2SSpeakSetSelfDef));

        public C2SSpeakSetSelfDef()
        {
            Id = 0;
            Content = "";
        }
