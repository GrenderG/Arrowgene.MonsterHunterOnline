...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 猎团站报名响应
    /// </summary>
    public class CSGuildMatchSignUpRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSGuildMatchSignUpRsp));

        public CSGuildMatchSignUpRsp()
        {
            ErrCode = 0;
            MatchID = 0;
            SignUpID = 0;
