...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class CSBTDebugBGListRsp : ICsStructure
    {
        ...
        public CSBTDebugBGListRsp()
        {
            Index = 0;
            ErrCode = 0;
            InstanceInfo = new List<CSBGInfo>();
        }
        ...
        public void WriteCs(IBuffer buffer)
        {
            ...
            short instanceInfoCount = (short)InstanceInfo.Count;
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            InstanceInfo.Clear();
            short instanceInfoCount = buffer.ReadInt16(Endianness.Big);
            for (int i = 0; i < instanceInfoCount; i++)
            {
