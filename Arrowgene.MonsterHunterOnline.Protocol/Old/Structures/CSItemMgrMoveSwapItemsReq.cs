...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求移动交换多个物品
    /// </summary>
    public class CSItemMgrMoveSwapItemsReq : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrMoveSwapItemsReq));

        public CSItemMgrMoveSwapItemsReq()
        {
