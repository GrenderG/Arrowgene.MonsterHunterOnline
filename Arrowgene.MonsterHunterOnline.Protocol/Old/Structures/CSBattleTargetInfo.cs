...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 关卡目标信息
    /// </summary>
    public class CSBattleTargetInfo : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSBattleTargetInfo));

        public CSBattleTargetInfo()
        {
            TargetID = 0;
            ConditionID = 0;
            CurCount = 0;
