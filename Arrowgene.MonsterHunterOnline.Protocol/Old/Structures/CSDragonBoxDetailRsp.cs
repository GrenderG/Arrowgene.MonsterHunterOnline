...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 龙人秘宝详细信息响应
    /// </summary>
    public class CSDragonBoxDetailRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSDragonBoxDetailRsp));

        public CSDragonBoxDetailRsp()
        {
            Id = 0;
            Reason = 0;
            Box = new List<byte>();
