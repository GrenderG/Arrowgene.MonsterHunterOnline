...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// attach消息
    /// </summary>
    public class CSActorAttachEntityNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSActorAttachEntityNtf));

        public CSActorAttachEntityNtf()
        {
            NetObjId = 0;
            SyncTime = 0;
            ParentGUID = 0;
