...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求rankup
    /// </summary>
    public class CSItemRebuildRankupReq : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemRebuildRankupReq));

        public CSItemRebuildRankupReq()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
