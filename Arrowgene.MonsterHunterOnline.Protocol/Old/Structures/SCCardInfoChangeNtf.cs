...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class SCCardInfoChangeNtf : ICsStructure
    {
        ...
        public SCCardInfoChangeNtf()
        {
            IllustrateCardInfo = new List<uint>();
        }

        /// <summary>
        /// 实体卡信息 2位暂未使用 10位怪索引 4位卡类型  16位卡数量 
        /// </summary>
        ...
        public void WriteCs(IBuffer buffer)
        {
            ...
            for (int i = 0; i < illustrateCardInfoCount; i++)
            {
                buffer.WriteUInt32(IllustrateCardInfo[i], Endianness.Big);
            }
        }
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            for (int i = 0; i < illustrateCardInfoCount; i++)
            {
                uint IllustrateCardInfoEntry = buffer.ReadUInt32(Endianness.Big);
                IllustrateCardInfo.Add(IllustrateCardInfoEntry);
            }
        }
