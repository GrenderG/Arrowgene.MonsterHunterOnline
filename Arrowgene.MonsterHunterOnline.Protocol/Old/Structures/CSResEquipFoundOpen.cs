...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 回复开启精铸属性
    /// </summary>
    public class CSResEquipFoundOpen : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSResEquipFoundOpen));

        public CSResEquipFoundOpen()
        {
            Ret = 0;
            EquipColumn = 0;
            EquipGrid = 0;
