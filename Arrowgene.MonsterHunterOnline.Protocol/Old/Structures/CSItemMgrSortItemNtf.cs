...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求整理排序物品
    /// </summary>
    public class CSItemMgrSortItemNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrSortItemNtf));

        public CSItemMgrSortItemNtf()
        {
            ItemColumn = 0;
            ItemBegGrid = 0;
            ItemEndGrid = 0;
