...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 通知客户端更新物品
    /// </summary>
    public class CSItemMgrUpdateItemNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrUpdateItemNtf));

        public CSItemMgrUpdateItemNtf()
        {
            Reason = 0;
