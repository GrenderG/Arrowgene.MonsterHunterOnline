...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class ScriptActivityDataScript : ScriptActivityDataUnion
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(ScriptActivityDataScript));

        public ScriptActivityDataScript()
        {
            Label = "";
            Params = new List<int>();
            Script = "";
        ...
        public EScriptActivityDataType Type => EScriptActivityDataType.kScriptActivityDataType_Script;
