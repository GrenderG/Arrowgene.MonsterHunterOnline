...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 镶嵌传奇技能珠-应答
    /// </summary>
    public class CSLegendPearlInlayRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSLegendPearlInlayRsp));

        public CSLegendPearlInlayRsp()
        {
            ErrCode = 0;
            EquipID = 0;
            EquipColumn = 0;
