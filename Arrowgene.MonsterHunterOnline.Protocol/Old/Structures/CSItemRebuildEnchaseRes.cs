...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求镶嵌装备
    /// </summary>
    public class CSItemRebuildEnchaseRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemRebuildEnchaseRes));

        public CSItemRebuildEnchaseRes()
        {
            ErrCode = 0;
            EquipID = 0;
            EquipColumn = 0;
