...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 请求销毁物品
    /// </summary>
    public class CSItemMgrDestroyItemReq : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemMgrDestroyItemReq));

        public CSItemMgrDestroyItemReq()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
