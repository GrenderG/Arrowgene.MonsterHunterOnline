...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物技能不装备应答
    /// </summary>
    public class CSPetSkillEquipOffRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetSkillEquipOffRsp));

        public CSPetSkillEquipOffRsp()
        {
            ErrCode = 0;
            Idx = 0;
            UID = 0;
