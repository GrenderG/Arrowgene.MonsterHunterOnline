...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class CSCommerceBoatInfo : ICsStructure
    {
        ...
        public CSCommerceBoatInfo()
        {
            CommerceBoatId = 0;
            CommerceBoatStartTime = 0;
            CommerceBoatStatus = 0;
            LevelId = 0;
        ...
        /// 商船ID
        /// </summary>
        public uint CommerceBoatId;

        /// <summary>
        /// 开始时间戳
        /// </summary>
        public int CommerceBoatStartTime;

        /// <summary>
        /// 商船状态
        /// </summary>
        public int CommerceBoatStatus;
