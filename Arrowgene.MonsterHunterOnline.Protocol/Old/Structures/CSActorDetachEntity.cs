...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// detach消息
    /// </summary>
    public class CSActorDetachEntity : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSActorDetachEntity));

        public CSActorDetachEntity()
        {
            SyncTime = 0;
            ParentGUID = 0;
            Location = new CSVec3();
