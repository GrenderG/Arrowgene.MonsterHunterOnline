...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 通知交换物品
    /// </summary>
    public class S2CGuildSwapItemNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(S2CGuildSwapItemNtf));

        public S2CGuildSwapItemNtf()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
