...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 技能珠回复upgrade
    /// </summary>
    public class CSLegendPearlRebuildUpgradeRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSLegendPearlRebuildUpgradeRes));

        public CSLegendPearlRebuildUpgradeRes()
        {
            RetCode = 0;
            errArg1 = 0;
            ItemID = 0;
