...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 猎团战淘汰赛每轮对决列表
    /// </summary>
    public class CSGuildMatchPairAdd : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSGuildMatchPairAdd));

        public CSGuildMatchPairAdd()
        {
            WinSignID = 0;
            Round = 0;
            Index = 0;
