...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 通知客户端删除物品
    /// </summary>
    public class S2CGuildDelItemNtf : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(S2CGuildDelItemNtf));

        public S2CGuildDelItemNtf()
        {
            ItemID = 0;
            ItemColumn = 0;
            ItemGrid = 0;
