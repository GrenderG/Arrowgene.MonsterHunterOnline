...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物技能遗忘应答
    /// </summary>
    public class CSPetSkillForgetRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetSkillForgetRsp));

        public CSPetSkillForgetRsp()
        {
            ErrCode = 0;
            Idx = 0;
            UID = 0;
