...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物技能装备请求
    /// </summary>
    public class CSPetSkillEquipOnReq : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetSkillEquipOnReq));

        public CSPetSkillEquipOnReq()
        {
            Idx = 0;
            UID = 0;
            SkillID = 0;
