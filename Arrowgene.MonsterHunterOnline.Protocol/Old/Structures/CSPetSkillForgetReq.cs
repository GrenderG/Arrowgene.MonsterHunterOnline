...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物技能遗忘请求
    /// </summary>
    public class CSPetSkillForgetReq : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetSkillForgetReq));

        public CSPetSkillForgetReq()
        {
            Idx = 0;
            UID = 0;
            SkillID = 0;
