...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 好友通知
    /// </summary>
    public class S2CFriendNotify : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(S2CFriendNotify));

        public S2CFriendNotify()
        {
            Type = 0;
            Arg1 = 0;
            Arg2 = 0;
        ...
        public void WriteCs(IBuffer buffer)
        {
            ...
            buffer.WriteInt32(Arg3.Length + 1, Endianness.Big);
            buffer.WriteCString(Arg3);
            buffer.WriteInt32(Arg4.Length + 1, Endianness.Big);
            buffer.WriteCString(Arg4);
            buffer.WriteUInt64(Arg5, Endianness.Big);
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            int Arg3EntryLen = buffer.ReadInt32(Endianness.Big);
            Arg3 = buffer.ReadString(Arg3EntryLen);
            int Arg4EntryLen = buffer.ReadInt32(Endianness.Big);
            Arg4 = buffer.ReadString(Arg4EntryLen);
            Arg5 = buffer.ReadUInt64(Endianness.Big);
