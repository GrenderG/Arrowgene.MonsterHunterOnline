...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class SCGuildFuncRecordRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(SCGuildFuncRecordRes));

        public SCGuildFuncRecordRes()
        {
            Count = 0;
        ...
        public void WriteCs(IBuffer buffer)
        {
            ...
            for (int i = 0; i < CsProtoConstant.CS_MAX_GET_GUILD_OPERATERECORD_LEN; i++)
            {
                GuildFuncRecordInfos[i].WriteCs(buffer);
            }
        }
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            for (int i = 0; i < CsProtoConstant.CS_MAX_GET_GUILD_OPERATERECORD_LEN; i++)
            {
                GuildFuncRecordInfos[i].ReadCs(buffer);
            }
        }
