...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    public class CSGuildCampOperationRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSGuildCampOperationRsp));

        public CSGuildCampOperationRsp()
        {
            ErrCode = 0;
            OperType = 0;
            OperLogicEntityID = 0;
        ...
        public void WriteCs(IBuffer buffer)
        {
            ...
            buffer.WriteInt32(OperLogicEntityID, Endianness.Big);
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            OperLogicEntityID = buffer.ReadInt32(Endianness.Big);
