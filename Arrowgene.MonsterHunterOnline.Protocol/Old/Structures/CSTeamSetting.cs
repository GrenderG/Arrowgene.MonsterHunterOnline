...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// </summary>
    public class CSTeamSetting : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSTeamSetting));
        ...
        public void ReadCs(IBuffer buffer)
        {
            ...
            Mode = buffer.ReadInt16(Endianness.Big);
            Map = buffer.ReadUInt32(Endianness.Big);
            LevelGrp = buffer.ReadUInt32(Endianness.Big);
            ...
            auth = buffer.ReadInt32(Endianness.Big);
