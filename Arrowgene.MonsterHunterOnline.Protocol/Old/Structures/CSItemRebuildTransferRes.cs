...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 装备转移Res
    /// </summary>
    public class CSItemRebuildTransferRes : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSItemRebuildTransferRes));

        public CSItemRebuildTransferRes()
        {
            ErrCode = 0;
            TransferAttr = 0;
            TransferType = 0;
