...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物技能装备应答
    /// </summary>
    public class CSPetSkillEquipOnRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetSkillEquipOnRsp));

        public CSPetSkillEquipOnRsp()
        {
            ErrCode = 0;
            Idx = 0;
            UID = 0;
