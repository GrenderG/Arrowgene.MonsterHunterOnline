...
namespace Arrowgene.MonsterHunterOnline.Protocol.Old.Structures
{
    ...
    /// 宠物天生技能升级应答
    /// </summary>
    public class CSPetGiftSkillLevelupRsp : ICsStructure
    {
        private static readonly ILogger Logger = LogProvider.Logger(typeof(CSPetGiftSkillLevelupRsp));

        public CSPetGiftSkillLevelupRsp()
        {
            ErrCode = 0;
            Idx = 0;
            UID = 0;
