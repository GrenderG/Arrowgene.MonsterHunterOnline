...
namespace Arrowgene.MonsterHunterOnline.Protocol.UnsafeTlvStructures
{
    ...
    /// </summary>
    public class TlvPetExtAttrData : Structure, ITlvStructure
    {
        ...
        public void WriteTlv(IBuffer buffer)
        {
            ...
            WriteTlvSubStructure(buffer, 142, OPetMana);
            WriteTlvSubStructure(buffer, 143, OPetMaxMana);
            WriteTlvSubStructure(buffer, 145, OAnimusHide);
            WriteTlvSubStructure(buffer, 146, ONoInterupt);
        }
    }
}
